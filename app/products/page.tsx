                ...
                >
                  ...
                  <div className="p-8 flex flex-col flex-1">
                    <div className="flex items-center gap-2 text-kodai-green">
                      <Award size={18} />
                      <span className="text-xs font-bold uppercase tracking-[0.22em]">{productsData.ui.premiumGrade}</span>
                    </div>
                      ...
                      <Dialog>
                        <DialogTrigger asChild>
                          <button className={cn(
                            ...
                            )}>{productsData.ui.moreDetails}</span>
                            <div className={cn(
                        ...
                        <DialogContent className="sm:max-w-[700px] rounded-3xl p-6 md:p-8 bg-white z-[60] border border-black/10 shadow-[0_24px_80px_rgba(26,31,46,0.14)] overflow-y-auto max-h-[90vh]">
                          ...
                          <div className="mt-4 space-y-6">
                            ...
                            <div>
                              <h4 className="font-bold text-kodai-dark mb-3">{productsData.ui.specifications}</h4>
                            ...
                            {product.applications && product.applications.length > 0 && (
                              <div>
                                <h4 className="font-bold text-kodai-dark mb-3">{productsData.ui.applications}</h4>
